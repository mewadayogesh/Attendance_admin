...
def format_datetime_ddmmyyyy(value):
    """Convert a 'YYYY-MM-DD HH:MM:SS' string to 'DD-MM-YYYY HH:MM:SS'.
...
def get_current_employee():
    ...
    if not username:
        return None
    conn = db.get_db()
    #Query run to fetching data from database (fetchone)
...
# # def user_request():
# #     # Render the user request template (create user_request.html in your templates folder)
# #     return render_template('user_request.html')

# @app.route('/send-attendance-email', methods=['POST'])
# @login_required
# def send_attendance_email():
#     sender_email = "digitalcrest781@gmail.com"
#     sender_password = "Crest@#2005$Web"  # Use an App Password, not your real password
#     #recipient_email = session.get('username') # Or an admin's email address
#     recipient_email = session.get('ymewada6262@gmail.com') # Or an admin's email address
    
#     # Optional: If you are generating a CSV/Excel file for the report, attach it here.
#     # For now, let's send a text/HTML report email.
    
#     subject = "Attendance Report"
#     body = "Hello,\n\nPlease find attached or enclosed your requested attendance report.\n\nBest Regards,\nHR System"

#     # Setup the MIME structure
#     msg = MIMEMultipart()
...
#     return redirect(url_for('report_leave')) # Redirect back to your report page
